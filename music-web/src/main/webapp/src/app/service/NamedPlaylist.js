...
angular
  ...
  .factory(
    ...
    function ($rootScope, $modal, Restangular, toaster) {
      ...
      $rootScope.publicCollaborativePlaylists = [];
      var service = {};
      ...
      service = {
        update: function () {
          ...
          Restangular.one("playlist/public")
            .get({
              limit: 1000,
            })
            .then(function (data) {
          ...
          Restangular.one("playlist/public/collaborative")
            .get({
              limit: 1000,
            })
            .then(function (data) {
              $rootScope.publicCollaborativePlaylists = data.items;
            });
        },
